...
try:
    ...
    mlb = joblib.load("mlb.pkl")  # MultiLabelBinarizer pour les tags supervisés
    topic_keywords = joblib.load("lda_topic_keywords.pkl")  # Mots-clés LDA
...
async def predict_tags(request: QuestionRequest):
    ...
    try:
        ...
        all_tags = mlb.classes_.tolist()  # Récupérer tous les tags connus
        bert_tags = nlp_bert(question, candidate_labels=all_tags)
